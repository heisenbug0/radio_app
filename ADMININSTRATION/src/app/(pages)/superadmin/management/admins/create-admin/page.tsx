  ...
  return (
    <>
      <div className="flex flex-row justify-between mt-3">
        <span className="font-bold text-2xl">Create admin</span>
        <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
          <Link
            href="/super-admin/management/admins"
        ...
        <form action="" className="space-y-12 w-full md:w-1/2">
          ...
          <div className="space-y-2">
            <div>
              <button
                type="button"
                className="w-full px-8 py-3 font-semibold rounded-full bg-primaryColor text-white dark:bg-violet-400 dark:text-gray-900"
              >
                Create admin
              </button>
            </div>
