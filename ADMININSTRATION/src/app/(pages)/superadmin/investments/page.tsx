...
import InvestmentLists from "@/components/super-admin/investment-lists";

const Investments = () => {
  return (
    <>
      <AccountInfoSuperadmin />
      <span className="font-bold text-2xl">Investments</span>
      ...
      <div className="flex flex-row justify-between gap-20">
        ...
        >
          <Link
            href="/super-admin/investments/addplan"
