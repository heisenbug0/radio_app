...
# Radiojar API Configuration
RADIOJAR_STREAM_NAME = config('RADIOJAR_STREAM_NAME', default='v994btp2gd0uv')
RADIOJAR_API_TIMEOUT = config('RADIOJAR_API_TIMEOUT', default=10, cast=int)