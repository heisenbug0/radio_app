#!/usr/bin/env python3
"""
High-Accuracy CNN Model for Product Recognition
Target: 90%+ accuracy
"""
...
class HighAccuracyCNNService:
    ...
    def create_ensemble_model(self, num_classes):
        ...
        base_model1 = applications.EfficientNetB3(
            weights='imagenet',
            include_top=False,
            input_shape=(*self.image_size, 3)
        )
    ...
    def train_model(self, data_dir, csv_file_path):
        ...
        self.model, base_model = self.create_transfer_learning_model(len(self.class_names))
    ...
    def save_model(self):
        ...
        # Save the model
        self.model.save(os.path.join(model_dir, "high_accuracy_cnn_model.h5"))
    ...
    def load_model(self):
        ...
        # Load the model
        self.model = tf.keras.models.load_model(os.path.join(model_dir, "high_accuracy_cnn_model.h5"))
...
def main():
    """Main function to train high-accuracy CNN"""
    print("High-Accuracy CNN Training")
    print("=" * 50)
    print("Target: 90%+ accuracy")
    
    # Initialize service
    cnn_service = HighAccuracyCNNService()
    ...
    try:
        ...
        if not os.path.exists(data_dir):
            ...
            print("Please run web scraping first: python run_web_scraping.py")
            return
        ...
        print("\n🎉 High-accuracy CNN training completed!")
