...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        stations_data = [
            {
                'name': 'Local Demo Station',
                'description': 'Demo station using local audio file',
                'stream_url': '/media/audio/setup.mp3',
            ...
            {
                'name': 'Radio Paradise',
                'description': 'Commercial-free, eclectic online radio from California',
                'stream_url': 'http://stream.radioparadise.com/aac-320',
                'website_url': 'https://radioparadise.com',
                'country': 'USA',
                'language': 'English',
                'quality': 'ultra',
                'bitrate': 320,
            ...
            },
            {
                ...
                'website_url': 'https://www.radioswissjazz.ch',
                'country': 'Switzerland',
                'language': 'English',
                'quality': 'medium',
                'bitrate': 128,
            ...
            {
                'name': 'NTS Radio',
                'description': 'Online radio station and media platform from London',
            ...
            {
                'name': 'KEXP Seattle',
                'description': 'Where the music matters - public radio from Seattle',
        ...
        self.stdout.write('')
        self.stdout.write('IMPORTANT: To use the local audio file:')
        self.stdout.write('1. Create directory: media/audio/')
        self.stdout.write('2. Copy your setup.mp3 file to: media/audio/setup.mp3')
        self.stdout.write('3. The first station will use this local file')
