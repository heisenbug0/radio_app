...
//Images
import img from "../../../public/client/investing.png";
import ellipse from "../../../public/client/ellipse28.png";
import secure from "../../../public/client/secure.png";
import income from "../../../public/client/growth.png";
import dollars from "../../../public/client/dollars.png";
import frame from "../../../public/client/frame01.png";
import trading from "../../../public/client/trading.png";
import makedeposit from "../../../public/client/deposit.png";
import chooseplan from "../../../public/client/plan.png";
import withdrawfunds from "../../../public/client/withdraw.png";
import refer from "../../../public/client/refer.png";
    ...
    <main className="flex min-h-screen flex-col items-center space-y-2 bg-white">
      <div className="container flex flex-col-reverse justify-center p-6 mx-auto md:py-12 lg:py-16 lg:flex-row lg:justify-between">
        <div className="flex flex-col justify-center p-6 text-center rounded lg:max-w-md xl:max-w-lg lg:text-left">
          ...
          <motion.div
            className="px-8 py-3 text-center text-lg font-semibold bg-primaryColor text-white hover:bg-secondaryColor rounded-full shadow-xl dark:border-gray-100"
      ...
      <div>
        <div className="container px-6 mx-auto md:mt-0 flex flex-col justify-center p-6 md:py-12 lg:py-16 lg:flex-col lg:justify-between">
          ...
          <p>
            With just a few clicks you can start earning active or passive
            income without having to actively manage your Investments. Here is
            how it works.
          </p>
            ...
            <div className="">
              ...
              <div className="container flex flex-col justify-center p-6 lg:space-x-4 mx-auto md:py-12 lg:py-16 lg:flex-row lg:items-center">
                <Image
                  src={trading}
                  alt=""
                  className="object-contain h-64 md:h-80 lg:h-56 xl:h-112 2xl:h-128 rounded-md shadow-2xl"
                />
                <motion.div
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                  className="px-8 py-3 text-sm text-center font-semibold bg-primaryColor text-white hover:bg-secondaryColor border rounded-full shadow-xl cursor-pointer dark:border-gray-100 mt-6 lg:mt-0"
                >
          ...
          <div className="flex flex-col justify-center p-6 lg:space-x-4 mx-auto md:py-12 lg:py-16 lg:flex-row lg:items-center ">
            <div className="card bg-base-100 w-auto h-96 shadow-xl border-2 flex flex-col items-center mb-6 lg:mb-0">
              ...
              <motion.div
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                className="px-8 py-2 mt-6 lg:mt-10 lg:py-2 lg:my-8 text-lg font-semibold bg-primaryColor text-white hover:bg-secondaryColor border rounded-full shadow-xl cursor-pointer dark:border-gray-100"
              >
